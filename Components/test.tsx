...
const HEART_RATE_UUID = '0000fd6f-0000-1000-8000-00805f9b34fb';
...
function Go(): BluetoothLowEnergyApi{
    ...
    const scanForPeripherals = async (): Promise<boolean> => {
        ...
        try {
            ...
            switch (result) {
                case RESULTS.UNAVAILABLE:
                    console.log('Bluetooth is not available (on this device / in this context xxxx)')
                    break
                case RESULTS.DENIED:
                    console.log('The Bluetooth permission has not been requested / is denied but requestable')
                    break
